...
class csaddschL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddschL> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH4CS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS schedules 4rth'),
