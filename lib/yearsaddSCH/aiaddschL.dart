...
class aiaddschL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddschL > {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH4AI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI schedules 4rth'),
