...
class isaddschS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddschS> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH2IS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS schedules 2nd'),
