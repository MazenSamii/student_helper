...
class csaddschT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddschT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH3CS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS schedules 3th'),
