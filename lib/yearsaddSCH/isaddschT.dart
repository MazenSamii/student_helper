...
class isaddschT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddschT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH3IS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS schedules 3th'),
