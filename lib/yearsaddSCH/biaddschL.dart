...
class biaddschL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddschL> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH4BI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI schedules 4rth'),
