...
class csaddschF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddschF> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH1CS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS schedules 1st'),
