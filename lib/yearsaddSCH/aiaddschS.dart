...
class aiaddschS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddschS > {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH2AI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI schedules 2nd'),
