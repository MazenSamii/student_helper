...
class isaddschF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddschF> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH1IS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS schedules 1st'),
