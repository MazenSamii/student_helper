...
class aiaddschF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddschF > {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH1AI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI schedules 1st'),
