...
class biaddschF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddschF > {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH1BI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI schedules 1st'),
