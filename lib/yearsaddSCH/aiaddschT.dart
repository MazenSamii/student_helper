...
class aiaddschT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddschT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH3AI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI schedules 3th'),
