...
class isaddschL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddschL> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH4IS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS schedules 4rth'),
