...
class biaddschS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddschS> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH2BI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI schedules 2nd'),
