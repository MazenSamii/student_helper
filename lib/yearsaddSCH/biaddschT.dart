...
class biaddschT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddschT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH3BI';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI schedules 3th'),
