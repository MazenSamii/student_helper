...
class csaddschS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddschS> {
  File? _file;
  String? _fileName;
  String _collectionName = 'SCH2CS';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS schedules 2nd'),
