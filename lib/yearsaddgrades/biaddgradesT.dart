...
class biaddgradesT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddgradesT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'BI3';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI grades 3th'),
