...
class biaddgradesS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddgradesS> {
  File? _file;
  String? _fileName;
  String _collectionName = 'BI2';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI grades 2nd'),
