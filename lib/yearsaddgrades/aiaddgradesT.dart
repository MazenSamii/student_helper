...
class aiaddgradesT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddgradesT > {
  File? _file;
  String? _fileName;
  String _collectionName = 'AI3';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI grades 3th'),
