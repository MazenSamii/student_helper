...
class csaddgradesL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddgradesL> {
  File? _file;
  String? _fileName;
  String _collectionName = 'CS4';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS grades 4rth'),
