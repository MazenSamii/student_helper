...
class isaddgradesF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddgradesF> {
  File? _file;
  String? _fileName;
  String _collectionName = 'IS1';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS grades 1st'),
