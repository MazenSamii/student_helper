...
class isaddgradesT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddgradesT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'IS3';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS grades 3th'),
