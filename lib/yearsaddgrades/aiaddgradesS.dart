...
class aiaddgradesS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddgradesS > {
  File? _file;
  String? _fileName;
  String _collectionName = 'AI2';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI grades 2nd'),
