...
class biaddgradesF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddgradesF> {
  File? _file;
  String? _fileName;
  String _collectionName = 'BI1';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI grades 1st'),
