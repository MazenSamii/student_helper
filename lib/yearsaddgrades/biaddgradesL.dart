...
class biaddgradesL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<biaddgradesL> {
  File? _file;
  String? _fileName;
  String _collectionName = 'BI4';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload BI grades 4rth'),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child:MaterialButton(
                      ...
                      onPressed:(){
                        Get.back(result: adminyearsbigrades());
                      }
                  ),
                )
              ],
