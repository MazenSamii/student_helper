...
class csaddgradesT extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddgradesT> {
  File? _file;
  String? _fileName;
  String _collectionName = 'CS3';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS grades 3th'),
