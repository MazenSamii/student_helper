...
import '../yearsGrades/adminyearsis.dart';
class isaddgradesL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddgradesL> {
  File? _file;
  String? _fileName;
  String _collectionName = 'IS4';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS grades 4rth'),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child:MaterialButton(
                      ...
                      onPressed:(){
                        Get.back(result: adminyearsisgrades());
                      }
                  ),
                )
              ],
