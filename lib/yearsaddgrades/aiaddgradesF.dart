...
class aiaddgradesF extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddgradesF > {
  File? _file;
  String? _fileName;
  String _collectionName = 'AI1';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('Upload AI grades 1st'),
