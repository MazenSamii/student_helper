...
class csaddgradesS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<csaddgradesS> {
  File? _file;
  String? _fileName;
  String _collectionName = 'CS2';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload CS grades 2nd'),
