...
class isaddgradesS extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<isaddgradesS> {
  File? _file;
  String? _fileName;
  String _collectionName = 'IS2';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload IS grades 2nd'),
