...
import '../yearsGrades/adminyearsai.dart';
class aiaddgradesL extends StatefulWidget {
  @override
  _FileUploadScreenState createState() => _FileUploadScreenState();
}
class _FileUploadScreenState extends State<aiaddgradesL > {
  File? _file;
  String? _fileName;
  String _collectionName = 'AI4';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Upload AI grades 4rth'),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child:MaterialButton(
                      ...
                      onPressed:(){
                        Get.back(result: adminyearsaigrades());
                      }
                  ),
                )
              ],
