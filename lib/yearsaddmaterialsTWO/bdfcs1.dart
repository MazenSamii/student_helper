...
import '../yearsaddmaterials/csaddmaterialsF.dart';

class bdfcs1 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('CSmaterials').add(
                                <String,dynamic>{
                                  "csstd":a,
                                  "we":b,
                                  "rt":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: csaddmaterialsF());
                        },
