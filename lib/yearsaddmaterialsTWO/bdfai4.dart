...
import 'package:student/yearsaddmaterials/aiaddmaterialsL.dart';

import '../mainPages/addingMaterialsPageD.dart';
import '../student/studentMainPage.dart';

class bdfai4 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('FourAImaterials').add(
                                <String,dynamic>{
                                  "fourAIstd":a,
                                  "mazen":b,
                                  "sami":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: aiaddmaterialsL());
                        },
