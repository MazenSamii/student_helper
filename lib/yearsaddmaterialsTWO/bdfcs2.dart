...
import '../yearsaddmaterials/csaddmaterialsS.dart';

class bdfcs2 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('WahedCSmaterials').add(
                                <String,dynamic>{
                                  "wahedCSstd":a,
                                  "zx":b,
                                  "cv":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: csaddmaterialsS());
                        },
