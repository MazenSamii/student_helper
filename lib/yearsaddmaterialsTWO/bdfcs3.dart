...
import 'package:student/yearsaddmaterials/csaddmaterialsT.dart';

import '../mainPages/addingMaterialsPageD.dart';
import '../student/studentMainPage.dart';

class bdfcs3 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('EtnenCSmaterials').add(
                                <String,dynamic>{
                                  "etnenCSstd":a,
                                  "za":b,
                                  "xs":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: csaddmaterialsT());
                        },
