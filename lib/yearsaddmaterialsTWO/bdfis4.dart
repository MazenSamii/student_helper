...
import 'package:student/yearsaddmaterials/isaddmaterialsL.dart';

import '../mainPages/addingMaterialsPageD.dart';
import '../student/studentMainPage.dart';

class bdfis4 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('ISaterials').add(
                                <String,dynamic>{
                                  "rabe3std":a,
                                  "awlmada":b,
                                  "tanimada":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: isaddmaterialsL());
                        },
