...
import '../yearsaddmaterials/aiaddmaterialsS.dart';

class bdfai2 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('TwoAImaterials').add(
                                <String,dynamic>{
                                  "twoAIstd":a,
                                  "one":b,
                                  "two":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: aiaddmaterialsS());
                        },
