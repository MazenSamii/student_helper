...
import 'package:student/yearsaddmaterials/isaddmaterialsT.dart';

import '../mainPages/addingMaterialsPageD.dart';
import '../student/studentMainPage.dart';

class bdfis3 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('wwmaterials').add(
                                <String,dynamic>{
                                  "letstd":a,
                                  "z":b,
                                  "c":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: isaddmaterialsT());
                        },
