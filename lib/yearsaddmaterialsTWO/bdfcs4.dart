...
import 'package:student/yearsaddmaterials/csaddmaterialsL.dart';

import '../mainPages/addingMaterialsPageD.dart';
import '../student/studentMainPage.dart';

class bdfcs4 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('TalataCSmaterials').add(
                                <String,dynamic>{
                                  "taltaCSstd":a,
                                  "q":b,
                                  "w":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: csaddmaterialsL());
                        },
