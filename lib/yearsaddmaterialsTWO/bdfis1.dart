...
import 'package:student/yearsaddmaterials/isaddmaterialsF.dart';

import '../mainPages/addingMaterialsPageD.dart';
import '../student/studentMainPage.dart';

class bdfis1 extends StatelessWidget {
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Center(
                        child: MaterialButton(
                          ...
                          onPressed:(){
                            ...
                            String f= s5.text;
                            String g= s6.text;
                            FirebaseFirestore.instance.collection('oomaterials').add(
                                <String,dynamic>{
                                  "awlstd":a,
                                  "u":b,
                                  "i":c,
                    ...
                    ,Container(
                      ...
                      child: MaterialButton(
                        onPressed:(){
                          Get.back(result: isaddmaterialsF());
                        },
