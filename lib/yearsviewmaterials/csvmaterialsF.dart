...
class csvmaterialsF extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          future: FirebaseFirestore.instance.collection('CSmaterials').get(),
                                      ...
                                      Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['csstd'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['we'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['rt'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['yu'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['sd'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['fg'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['hj'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
