...
class aivmaterialsT extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          future: FirebaseFirestore.instance.collection('ThreeAImaterials').get(),
                                      ...
                                      Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['threeAIstd'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['seven'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['eight'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['nine'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['ten'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['eleven'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['twelv'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
