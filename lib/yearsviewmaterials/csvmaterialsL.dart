...
class csvmaterialsL extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          future: FirebaseFirestore.instance.collection('TalataCSmaterials').get(),
                                      ...
                                      Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['taltaCSstd'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['q'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['w'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['e'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['r'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['t'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['y'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
