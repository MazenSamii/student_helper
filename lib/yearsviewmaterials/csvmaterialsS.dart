...
class csvmaterialsS extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          future: FirebaseFirestore.instance.collection('WahedCSmaterials').get(),
                                      ...
                                      Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['wahedCSstd'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['zx'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['cv'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['bn'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['ml'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['nk'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['bj'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
