...
class isvmaterialsT extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: FutureBuilder(
          future: FirebaseFirestore.instance.collection('wwmaterials').get(),
                                      ...
                                      Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['letstd'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['z'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['c'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['vv'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['b'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['nn'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              ,Text(x.data.docs[index]['mm'],style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),),
                                            ],
                                          )
                                      )
                                      ,Container(
